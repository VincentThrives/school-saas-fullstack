  ...
  private buildMenu(): void {
    ...
    if (role === UserRole.SCHOOL_ADMIN || role === UserRole.PRINCIPAL) {
      items.push(
        ...
        { title: 'Attendance', path: '/attendance', icon: 'event_note', feature: 'attendance' },
        ...
        { title: 'Fees', path: '/fees', icon: 'payment', feature: 'fee', roles: [UserRole.SCHOOL_ADMIN] },
        ...
        { title: 'Reports', path: '/reports', icon: 'description', feature: 'analytics', roles: [UserRole.SCHOOL_ADMIN, UserRole.PRINCIPAL] },
    ...
    if (role === UserRole.TEACHER) {
      items.push(
        ...
        { title: 'Exams', path: '/exams', icon: 'assignment', feature: 'exams' },
        { title: 'MCQ Exams', path: '/mcq', icon: 'quiz', feature: 'mcq' },
        { title: 'Study Materials', path: '/study-materials', icon: 'menu_book', feature: 'content' },
